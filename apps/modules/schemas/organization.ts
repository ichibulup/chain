...
export const CreateRestaurantSchema = z.object({
  ...
  chainId: z.preprocess(
    ...
    z.string().uuid('Invalid chain ID').optional().nullable()
  ),
  ...
  phoneNumber: z.preprocess(
    (value) => (value === "" ? undefined : value),
    z.string().min(10).max(10).optional().nullable()
  ),
  email: z.preprocess(
    (value) => (value === "" ? undefined : value),
  ...
  coverUrl: z.preprocess(
    (value) => (value === "" ? undefined : value),
    z.string().url('Invalid cover URL').optional().nullable()
  ),
  logoUrl: z.preprocess(
    (value) => (value === "" ? undefined : value),
    z.string().url('Invalid logo URL').optional().nullable()
  ),
  status: RestaurantStatus,
  timezone: z.string().nullable(),
});

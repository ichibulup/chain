...
// Update reservation
router.put('/reservation/:id', requireAuth(), updateReservation);

// Delete reservation
router.delete('/reservation/:id', requireAuth(), deleteReservation);
...
router.post('/role', requireAuth(), createRestaurantUserRole);

// Get all restaurant user roles with filtering
router.get('/role', requireAuth(), getRestaurantUserRoles);

// Get restaurant user role by ID
router.get('/role/:id', requireAuth(), getRestaurantUserRoleById);

// Update restaurant user role
router.put('/role/:id', requireAuth(), updateRestaurantUserRole);

// Delete restaurant user role
router.delete('/role/:id', requireAuth(), deleteRestaurantUserRole);
